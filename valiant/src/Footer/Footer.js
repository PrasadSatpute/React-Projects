            ...
            <div className="row text-white bg-dark">
                <div className="col-sm-4 text-white bg-dark">
                    ...
                    <div className="card-body text-white bg-dark text-center">
                        ...
                        <p className="card-text">Special Construction</p>
                        <p className="card-text">Building Site Work</p>
                        <p className="card-text">Company Site Work</p>
                ...
                <div className="col-sm-4 text-white bg-dark">
                    ...
                    <div className="card-body text-white bg-dark text-center">
                        ...
                        <p className="card-text">   Praesent sed lobortis mi. 
